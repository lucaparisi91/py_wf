...
def test_node():
    ...
    node3= Node("hello3",task=Task(dummy_task3,executor=executor), dependencies= [ node1,node2] )
...
def test_dyamond():
    ...
    node1= Node("hello1d",task=Task(dummy_task(1),executor=executor ) , dependencies=[node0])
    node2= Node("hello2d",task=Task(dummy_task(2),executor=executor) , dependencies=[node0])
    node3 = Node("hello3d",task=Task(dummy_task(3),executor=executor) , dependencies=[node1,node2])
