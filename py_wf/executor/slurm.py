...
slurmFailedStates= set ([SlurmState.BOOT_FAIL,
...
class SlurmExecutor(Executor):
    ...
    def __init__(self,preScript: str = "", maxProcesses : int = 4,default_resources={},polling_interval=10) :
    ...
    def __call__(self, script: str, work_dir : Path = Path(".") , name = "py_wf_job" , resources={}) -> asyncio.Task:
        ...
        async def submit_and_wait():
            ...
            state=None
            while (not state in (slurmCompletedStates)
    ):
